...
%>
       ...
       <div class="navbar-default">
         ...
         <a onmouseover="this.style.backgroundColor='#640404'" onmouseout="this.style.backgroundColor='#8c0404'" style="text-shadow: 0px 0px 5px #000000;color: #ffffff;" class="navbar-brand" href="<%= request.getContextPath() %>/"><img height="38" src="<%= request.getContextPath() %>/image/ITFIP.png" alt="logo ITFIP" /></a>
       </div>
       <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
         <ul class="nav navbar-nav">
          ...
          <li class="dropdown">
             <a onmouseover="this.style.backgroundColor='#640404'" onmouseout="this.style.backgroundColor='#8c0404'" style="text-shadow: 0px 0px 5px #000000;color: #ffffff;" href="#" class="dropdown-toggle" data-toggle="dropdown"><fmt:message key="jsp.layout.navbar-admin.contents"/> <b style="border-top-color: #ffffff; border-bottom-color: #ffffff;" class="caret"></b></a>
           ...
           <li class="dropdown">
             <a onmouseover="this.style.backgroundColor='#640404'" onmouseout="this.style.backgroundColor='#8c0404'" style="text-shadow: 0px 0px 5px #000000;color: #ffffff;" href="#" class="dropdown-toggle" data-toggle="dropdown"><fmt:message key="jsp.layout.navbar-admin.accesscontrol"/> <b style="border-top-color: #ffffff; border-bottom-color: #ffffff;" class="caret"></b></a>
             <ul class="dropdown-menu">
          ...
          <li><a onmouseover="this.style.backgroundColor='#640404'" onmouseout="this.style.backgroundColor='#8c0404'" style="text-shadow: 0px 0px 5px #000000;color: #ffffff;" href="<%= request.getContextPath() %>/statistics"><fmt:message key="jsp.layout.navbar-admin.statistics"/></a></li>
      <li class="dropdown">
             <a onmouseover="this.style.backgroundColor='#640404'" onmouseout="this.style.backgroundColor='#8c0404'" style="text-shadow: 0px 0px 5px #000000;color: #ffffff;" href="#" class="dropdown-toggle" data-toggle="dropdown"><fmt:message key="jsp.layout.navbar-admin.settings"/> <b style="border-top-color: #ffffff; border-bottom-color: #ffffff;" class="caret"></b></a>
             <ul class="dropdown-menu">
