...
<dspace:layout locbar="commLink" title="<%= name %>" feedData="<%= feedData %>">
    <div class="well">
    <div class="row">
    <div class="col-md-12"><h2><strong><%= name %></strong>&nbsp;&nbsp;&nbsp;
<%
...
<% 	} %>
  ...
  <div class="panel panel-primary">
    ...
    <center>
        <strong><fmt:message key="jsp.general.browse"/></strong>
    </center>	
  </div>
...
%>
	<form method="get" action="<%= request.getContextPath() %>/handle/<%= collection.getHandle() %>/browse">
		...
		<input type="submit" class="btn btn-default col-md-3" name="submit_browse" value="<fmt:message key="<%= key %>"/>"/>
	</form>
<%	
	}
%>	</div>
...
%>
    ...
    <div class="browse_range">
        <p class="alert alert-info"><fmt:message key="jsp.collection-home.content.range"></p>
